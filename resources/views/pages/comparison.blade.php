    ...
    <section>
        ...
        <div class="banner">
            <div class="w-100 ms-md-5 pt-5 padding-left">
                ...
                <p class="h6 text-white px-3 variants-tag-line text-md-start mt-3">Detailed comparison between Editute
                    Variants</p>
            </div>
    ...
    <div class="container-fluid main-div bg-light">
        <div class="row justify-content-lg-around row-black-border">
            ...
            <div class="col-lg-2  col-black-border">
                <p class="h6 text-black">Editute Lite <span class="h4 fw-bold">$0</span></p>
            ...
            <div class="col-lg-2 col-black-border">
                <p class="h6 text-black">Editute Regular <span class="h4 fw-bold">$19</span></p>
                <p class="text-sm">Limited Feature School ERP, Suitable for School < 100 Students </p>
            ...
            <div class="col-lg-2  col-pink-border">
                <p class="h6 text-pink">Editute Plus <span class="h4 text-black fw-bold">$49</span></p>
            ...
            <div class="col-lg-2 col-black-border">
                <p class="h6 text-black">Editute SaaS <span class="h4 fw-bold">$299</span></p>
                <p class="text-sm">Limited Feature School ERP, Suitable for School < 100 Students </p>
                        <div class="card uper_card plan-column mt-4 rounded shadow text-center">
                            <p><i class="fa-solid fa-check"></i></p>
                            <hr>
        ...
        <div class="row justify-content-lg-around">
            ...
            <div class="col-lg-2">
                <div class="card mt-5 plan-column rounded shadow text-center">
                    ...
                    <p><i class="fa-solid fa-x"></i></p>
                    <hr>
                    <p><button class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle1"
                            role="button">Order Now</button></p>
            ...
            <div class="col-lg-2">
                <div class="card mt-5 plan-column rounded shadow text-center">
                    ...
                    <p class="text-sm text-black">Basic</p>
                    <hr>
                    <p><button class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle2"
                        role="button">Order Now</button></p>
            ...
            <div class="col-lg-2">
                <div class="card mt-5 plan-column pink-border rounded shadow text-center">
                    ...
                    <p class="text-sm text-pink">Advanced</p>
                    <hr>
                    <p><button class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle3"
                        role="button">Order Now</button></p>
            ...
            <div class="col-lg-2">
                <div class="card mt-5 plan-column rounded shadow text-center">
                    ...
                    <p class="text-sm text-black">Advanced</p>
                    <hr>
                    <p><button class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle4"
                            role="button">Order Now</button></p>
