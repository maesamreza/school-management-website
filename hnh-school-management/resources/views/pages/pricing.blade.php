...
<section>
    ...
    <div class="w-100 ms-md-5 pt-5">
        ...
        <p class="h5 text-center mt-3 px-1 px-lg-0">We are on a mission to offer best possible School ERP solution at a affordable cost. Check out our pricing.</p>
    </div>
...
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Self Hosted License</p>
</div>
<p class="ms-2 text-black mt-4 mb-2 font-medium">OPTIONAL
</p>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> 12 Month of Support @ $149</p>
</div>
...
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Single Instance</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> White Label Solution</p>
</div>
<p class="ms-2 text-black mt-4 mb-2 font-medium">OPTIONAL
</p>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Free Installation (Extended License)</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> 12 Month of Support @ $149</p>
</div>
...
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Free Installation</p>
</div>
<p class="ms-2 text-black mt-4 mb-2 font-medium">OPTIONAL
</p>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Server Pre-requisite Setup (Developer License)</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Pre-populated Demo Data (Developer License)</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> 12 Month of Support @ $149</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Developer License (Unlimited Instances) @ $1499</p>
</div>
        </div>
        <div class="col-lg-3 col-md-6 my-2 card rounded-3" style="width: 18rem;">
        <div class="price-tag p-3">
...
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Server Pre-requisite Setup</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text">Pre-populated Demo Data</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Admin Interface</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> Accept Online Payment</p>
</div>
<p class="ms-2 text-black mt-4 mb-2 font-medium">OPTIONAL
</p>
...
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text"> 12 Month of Support @ $699</p>
</div>
<div class="d-flex my-2 align-items-center ms-3">
<i class="fa-solid fa-check"></i> <p class="ms-3 price-tag-text">Developer License (Unlimited Instances) @ $2999</p>
</div>
