                ...
                <div class="col-12">
                    <div>
                        ...
                        <p class="powerful_para text-center mt-3">
                            InstiKit has curated list of modules, easy to understand & operate, <br> scalable and well planned future development roadmap.
                        </p>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="text-center">
                                            <img class="img-fluid instikit-logo" src="{{asset('assets/img/logo/logo1.png')}}" alt="">
                                        </div>
                                        <p class="amazing_para text-center mt-3">
                                            “Amazing product. Best code quality so far I have seen. It covers <br> most of the aspects of any educational institution and more over <br> ScriptMint keeps developing it to add more features.”
                                        </p>
                                        <p class="text-center mt-3">
                                            <span class="saifullah">Samar Turabi </span> <span class="slash">/</span> <span class="trainer"> Trainer & Motivational Speaker</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
