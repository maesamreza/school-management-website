...
<section>
    ...
    <div class="banner">
        <div class="w-100 ms-md-5 pt-5">
            ...
            <p class="h5 text-white text-center text-md-start mt-3">Didn't find something you are looking for? Request for new features!</p>
        </div>
...
<section>
    ...
    <div class="pt-5">
        <h1 class=" text-center">Reach us for New Features</h1>
        <p class="h5 text-center mt-3 px-1 px-lg-0">We would like to hear from you. Share your ideas/features you would like to have in InstiKit!</p>
    </div>
